document.addEventListener('DOMContentLoaded', function () {
    ...
    function NAMESLIDER() {
        var swiper = new Swiper('.sub_name_slider', {
            slidesPerView: 1,
            spaceBetween: 20,
            speed: 1000,
            loop: true,
    ...
    function render() {
        ...
        for (var i = 0; i < cloudCount; i++) {
            context.drawImage(clouds[i].img, clouds[i].x - clouds[i].img.width / 10, clouds[i].y - clouds[i].img.height / 10);
        }
        context.beginPath();
